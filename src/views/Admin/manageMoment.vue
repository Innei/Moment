<template>
  <layout @btn-click="$parent.$data.dialogs.post = true">
    ...
    <template #main>
      <Table :data="data" :cols="cols" :options="options"></Table>
    </template>
  </layout>
</template>
